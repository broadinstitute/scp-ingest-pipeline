...
class CellMetadata(IngestFiles):
    ...
    #     # storage size of the source file name, document name, and file type
    #     document_name_storage = len(document_name) +1
    #     size_of_cell_names_field = 11 + 1
    #     size_of_values_field = 7 + 1
    #     starting_sum = 0
    #     start_index = 0
    #     float_storage = 8
    #     sum = starting_sum
