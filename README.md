...
```
The hooks will expect that git-secrets has been set up. If you have not done this, please see: [broadinstitute/single_cell_portal_configs](https://github.com/broadinstitute/single_cell_portal_configs).
